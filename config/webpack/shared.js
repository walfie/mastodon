...
const themePackPaths = require('./generateThemePacks');

const extensionGlob = `**/*{${settings.extensions.join(',')}}*`;
const entryPath = join(settings.source_path, settings.source_entry_path);
const packPaths = sync(join(entryPath, extensionGlob));
const entryPacks = [...packPaths, ...localePackPaths, ...themePackPaths].filter(path => path !== join(entryPath, 'custom.js'));
  ...
  entry: entryPacks.reduce(
    (map, entry) => {
      ...
      if (namespace.startsWith('../../../tmp/')) {
        namespace = ''; // generated by generateLocalePacks.js or generateThemePacks.js
      }
