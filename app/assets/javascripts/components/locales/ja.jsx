const ja = {
  ...
  "compose_form.privacy_disclaimer": "あなたの非公開カツは返信先ユーザーが所属する {domains} に送信されます。{domainsCount, plural, one {このサーバー} other {これらのサーバー}}は信頼できますか？投稿のプライバシー保護はMastodonサーバー内でのみ有効です。 {domains} {domainsCount, plural, one {がMastodonインスタンス} other {がMastodonインスタンス}}でない場合、あなたの投稿がプライベートなものとして扱われず、ブーストされたり予期しないユーザーに見られる可能性があります。",
  ...
  "notification.favourite": "{name} さんがあなたのカツをお気に入りに登録しました",
  "notification.follow": "{name} さんにフォローされました",
  "notification.mention": "{name} さんがあなたに返信しました",
  "notification.reblog": "{name} さんがあなたのカツをブーストしました",
  ...
  "onboarding.page_six.admin": "キラキラッターは{admin}学園長によって運営されています。",
  "onboarding.page_six.almost_done": "Let's アイカツ!",
  "onboarding.page_six.apps_available": "色々な人のカツが溢れているキラキラッターで、あなたの熱いアイドル活動、ｱｲｶﾂ!始まります。",
  "onboarding.page_six.github": "情報に流されすぎたり、夢中になりすぎたりせず、気を付けて使いましょう。「つぶやきにご用心！」",
  "onboarding.page_six.guidelines": "コミュニティガイドライン",
  "onboarding.page_six.read_guidelines": "{guidelines}を必ずお読みください。",
  ...
  "onboarding.page_six.appetoot": "ﾌﾌｯﾋ",
