...
const en = {
  ...
  "onboarding.page_six.admin": "The Kirakiratter admin is {admin}.",
  "onboarding.page_six.almost_done": "Let's Aikatsu!",
  "onboarding.page_six.appetoot": "Your passionate idol activities, Aikatsu! is about to start!",
  "onboarding.page_six.apps_available": "Please enjoy seeing everyone's katsus on Kirakiratter.",
  "onboarding.page_six.github": 'Make sure to katsu responsibly, and take breaks every once in a while, too. "Beware the Blog!"',
  "onboarding.page_six.guidelines": "community guidelines",
  "onboarding.page_six.read_guidelines": "Please don't forget to read {domain}'s {guidelines}!",
  "onboarding.page_six.various_app": "mobile apps",
  "onboarding.page_three.profile": "Edit your profile to change your avatar, bio, and display name. There, you will also find other preferences.",
  "onboarding.page_three.search": "Use the search bar to find people and look at hashtags. You can interact with Aikatsu fans all over the world by searching for {illustration} and {introductions}. To look for a Mastodon user who is not on this instance, use their full handle.",
